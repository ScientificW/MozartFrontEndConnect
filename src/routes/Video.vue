<template>
    <div class="row">
      <div class="side">
        <div class="col-3 menu">
          <ul>
            <li><a> 操作指南</a></li>
            <p>您可以输入一张您希望获得配乐的图片</p>
            <p>点击添加图片，选择您的图片。</p>
            <p>点击提交，等待生成您的专属配乐吧！</p>
            <br/>
            <li><a>温馨提示</a></li>
            <p>图片与音乐的情感色彩较为主观，本站生成的音乐不一定符合您的预想。</p>
  ...
  <script lang="ts" setup>
    import Form from '../components/VideoForm.vue';
    import Music from "../components/VideoMusic.vue";
    import {ref} from "vue";
